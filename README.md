...
- TradingAgents: Multi-Agents LLM Financial Trading Framework （UCLA, MIT, Tauric Research, 25-06）[[Arxiv]](https://arxiv.org/pdf/2412.20138)

- AlphaAgents: Large Language Model based Multi-Agents for Equity Portfolio Constructions (25-08) [[Arxiv]](https://arxiv.org/abs/2508.11152)
...
- FinMCP-Bench: Benchmarking LLM Agents for Real-World Financial Tool Use under the Model Context Protocol (Qwen Dianjin team) [[ResearchGate]](https://www.researchgate.net/publication/396371996_FinMCP-Bench_Benchmarking_LLM_Agents_for_Real-World_Financial_Tool_Use_under_the_Model_Context_Protocol) [[GitHub]](https://github.com/aliyun/qwen-dianjin)
